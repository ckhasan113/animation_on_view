...
const memoriesLightText = document.querySelector(".light-text");
const memoriesBoldText = document.querySelector(".bold-text");
const memoriesImages = document.querySelectorAll(".memories-section img");
...
document.addEventListener("scroll", function () {
  ...
  skills.forEach(skill => {
    ...
    if((skill.getBoundingClientRect().y + ((skill.getBoundingClientRect().height * 3 ) / 4))  < clientHeight){
        skill.style.animation = "fadeInUp 1s forwards cubic-bezier(0.87, 0, 0.13, 1)";
    }
  });
